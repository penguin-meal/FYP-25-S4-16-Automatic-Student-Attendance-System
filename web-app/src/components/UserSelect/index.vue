      ...
      <el-row :gutter="20">
        ...
        <el-col :lg="4" :xs="24" style="">
          <el-card shadow="hover">
            <el-input v-model="deptName" placeholder="Please enter department name" prefix-icon="Search" clearable />
            <el-tree
              ref="deptTreeRef"
              class="mt-2"
              node-key="id"
        ...
        <el-col :lg="20" :xs="24">
              ...
              <el-card shadow="hover">
                <el-form ref="queryFormRef" :model="queryParams" :inline="true">
                  ...
                  <el-form-item label="Mobile Number" prop="phonenumber">
                    <el-input v-model="queryParams.phonenumber" placeholder="Please enter mobile number" clearable @keyup.enter="handleQuery" />
                  </el-form-item>
                  <el-form-item>
          ...
          <el-card shadow="hover">
            ...
            >
              ...
              <vxe-column key="userId" title="User ID" align="center" field="userId" />
              <vxe-column key="userName" title="Username" align="center" field="userName" />
              <vxe-column key="nickName" title="Display Name" align="center" field="nickName" />
              <vxe-column key="deptName" title="Department" align="center" field="deptName" />
              <vxe-column key="phonenumber" title="Mobile Number" align="center" field="phonenumber" width="120" />
              <vxe-column key="status" title="Status" align="center">
                <template #default="scope">
                  <dict-tag :options="sys_normal_disable" :value="scope.row.status"></dict-tag>
                </template>
              </vxe-column>

              <vxe-column title="Created At" align="center" width="160">
                <template #default="scope">
